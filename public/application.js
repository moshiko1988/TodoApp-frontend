...
/***/ function(module, exports, __webpack_require__) {
	...
	var lists = __webpack_require__(13);
	$(function () {
...
/***/ function(module, exports) {
	...
	var config = {
	  apiOrigins: {
	    production: 'https://mighty-lake-67630.herokuapp.com/'
	  }
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onSignUp = function onSignUp(event) {
	  ...
	  api.signUp(data).then(ui.signUpSuccess).then(ui.success).then(function () {
	    $("#sign-up-btb").toggleClass("open");
	...
	var onSignIn = function onSignIn(event) {
	  ...
	  api.signIn(data).then(function (response) {
	    ...
	    return store.user;
	  }).then(ui.signInSuccess).then(ui.success).catch(ui.signInError);
	};
	...
	var onChangePassword = function onChangePassword(event) {
	  ...
	  api.changePassword(data).then(ui.changePasswordSuccess).then(ui.success).then(function () {
	    $("#change-password-button").toggleClass("open");
	...
	var onSignOut = function onSignOut(event) {
	  ...
	  api.signOut().then(function () {
	    delete store.user;
	    return store;
	  }).then(ui.signOutSuccess).then(ui.success).catch(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onGetList = function onGetList(event) {
	  if (event) {
	    event.preventDefault();
	  }
	  api.index().then(function (response) {
	    ...
	    return store;
	  }).then(ui.getListSuccess).catch(ui.failure);
	};

	var onDeleteList = function onDeleteList(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  api.destroy(id).then(ui.onDeleteSuccess).then(onGetList).catch(ui.onError);
	};

	var onPatchList = function onPatchList(event) {
	  event.preventDefault();
	  var id = event.target.dataset.id;
	  var data = getFormFields(event.target);
	  api.patch(id, data).then(ui.onPatchSuccess).then(onGetList).catch(ui.onError);
	};

	var onCreateList = function onCreateList(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.post(data).then(ui.onCreateSuccess).then(onGetList).then(function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var patch = function patch(id, data) {
	  return $.ajax({
	    url: config.apiOrigin + '/lists/' + id,
	    method: 'PATCH',
	    headers: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showListTemplate = __webpack_require__(16);
	var store = __webpack_require__(11);

	var getListSuccess = function getListSuccess(data) {
	  var showListHtml = showListTemplate({
	    lists: data.lists
	  });
	...
	var onPatchSuccess = function onPatchSuccess() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "\n  <table class=\"table\" data-id=\""
	    ...
	    + "\">\n\n    <td>\n      <h3 data-id=\""
	    + alias4(alias5(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\">"
	    + alias4(((helper = (helper = helpers.note || (depth0 != null ? depth0.note : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"note","hash":{},"data":data,"blockParams":blockParams}) : helper)))
	    + "</h3></td>\n    <td><button data-id=\""
	    + alias4(alias5(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"button\" name=\"button\" class=\"remove-list btn-danger glyphicon glyphicon-remove-sign\"></button>\n\n\n      <li data-id=\""
	    + alias4(alias5(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class=\"dropdown\">\n        <a href=\"#\" class=\"dropdown-toggle\" data-toggle=\"dropdown\"><b>edit</b> </a>\n        <ul class=\"dropdown-menu\">\n          <li>\n            <div class=\"row\">\n              <div class=\"col-md-12\">\n\n\n                <form data-id=\""
	    + alias4(alias5(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" class='edit-list'>\n                  <div class=\"form-group\">\n                    <input data-id=\""
	    + alias4(alias5(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"text\" name=\"list[note]\" placeholder=\"Edit list \">\n                  </div>\n                  <button data-id=\""
	    + alias4(alias5(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + "\" type=\"submit\" class=\"btn btn-info\">Edit Note </button>\n                </form>\n\n              </div>\n            </div>\n          </li>\n        </ul>\n      </li>\n    </td>\n  </table>\n\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;

	  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : {},(depth0 != null ? depth0.lists : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 1, blockParams),"inverse":container.noop,"data":data,"blockParams":blockParams})) != null ? stack1 : "");
